...
if ($Proof == "Aadhar Card") {
    echo '<a href="Adhaar/pdf.pdf"><input type="submit" value="Download" /></a><br>';
}
if ($Proof == "License") {
    echo '<a href="License/pdf.pdf"><input type="submit" value="Download" /></a><br>';
}
if ($Proof == "Voter Id") {

    echo '<a href="Voter/pdf.pdf"><input type="submit" value="Download" /></a><br>';
}
if ($Proof == "Pan") {
    echo '<a href="Pan/pdf.pdf"><input type="submit" value="Download" /></a><br>';
}
